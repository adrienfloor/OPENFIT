...
const styles = StyleSheet.create({
  ...
  container: { flex: 1, backgroundColor: '#f9fafb', paddingHorizontal: 24, paddingTop: 80 },
  ...
  subtitleSmall: { fontSize: 13, color: '#9ca3af', marginBottom: 48 },
  startBtn: { backgroundColor: '#a855f7', paddingHorizontal: 56, paddingVertical: 20, borderRadius: 16 },
  ...
  hrSection: { backgroundColor: '#fff', borderRadius: 16, padding: 20, marginBottom: 32 },
  ...
  hrStatUnit: { fontSize: 10, color: '#9ca3af', marginTop: 2 },
  hrZoneText: { fontSize: 13, fontWeight: '700', marginTop: 8 },
  hrZoneHigh: { color: '#ef4444' },
  hrZoneMid: { color: '#f59e0b' },
  hrZoneLow: { color: '#22c55e' },
  hrConnectionStatus: { fontSize: 12, color: '#9ca3af', textAlign: 'center', marginTop: 12 },
  controls: { flexDirection: 'row', gap: 12, marginTop: 24 },
  pauseBtn: { flex: 1, backgroundColor: '#f59e0b', paddingVertical: 18, borderRadius: 12, alignItems: 'center' },
  pauseBtnText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  resumeBtn: { flex: 1, backgroundColor: '#22c55e', paddingVertical: 18, borderRadius: 12, alignItems: 'center' },
  resumeBtnText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  stopBtn: { flex: 1, backgroundColor: '#ef4444', paddingVertical: 18, borderRadius: 12, alignItems: 'center' },
  stopBtnText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  saveBtn: { flex: 2, backgroundColor: '#22c55e', paddingVertical: 18, borderRadius: 12, alignItems: 'center' },
  saveBtnText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  discardBtn: { flex: 1, backgroundColor: '#f3f4f6', paddingVertical: 18, borderRadius: 12, alignItems: 'center' },
  discardBtnText: { color: '#6b7280', fontSize: 16, fontWeight: '600' },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#fff', borderRadius: 12, padding: 20 },
